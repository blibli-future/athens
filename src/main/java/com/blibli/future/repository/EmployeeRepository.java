...
public interface EmployeeRepository extends JpaRepository<Employee, String> {
    ...
    @Query(value = "select new com.blibli.future.vo.EmployeeResponseVo(e.nik, e.fullName, e.gender, e.position, e.organizationalUnitText, e.maritalStatus, e.religion, e.nameOfDept, e.chiefNik, e.chiefName, e.startWorkingDate) from Employee e")
