...
public class HomeController {
	...
	final String CHART_PATH = BASE_PATH + "/chart/{type}";
	...
	public ResponseEntity<ChartResponse> displayChart(@PathVariable String type, @RequestParam String dept) throws TypeNotFoundException{
